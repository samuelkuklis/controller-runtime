[![Go Report Card](https://goreportcard.com/badge/github.com/samuelkuklis/controller-runtime)](https://goreportcard.com/report/github.com/samuelkuklis/controller-runtime)
[![godoc](https://pkg.go.dev/badge/github.com/samuelkuklis/controller-runtime)](https://pkg.go.dev/github.com/samuelkuklis/controller-runtime)
...
- [Package overview](https://pkg.go.dev/github.com/samuelkuklis/controller-runtime/pkg)
- [Basic controller using builder](https://pkg.go.dev/github.com/samuelkuklis/controller-runtime/pkg/builder#example-Builder)
- [Creating a manager](https://pkg.go.dev/github.com/samuelkuklis/controller-runtime/pkg/manager#example-New)
- [Creating a controller](https://pkg.go.dev/github.com/samuelkuklis/controller-runtime/pkg/controller#example-New)
